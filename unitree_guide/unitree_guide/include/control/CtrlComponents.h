...
public:
    ...
    CtrlComponents(IOInterface *ioInter, pinocchio::Data *data, pinocchio::Model *model,Vec34 *q_contact):ioInter(ioInter)
    {   _q_contact=q_contact;
        _data = data;
        _model = model;
        lowCmd = new LowlevelCmd();
        lowState = new LowlevelState();
    ...
    void geneObj(){
        ...
        balCtrl = new BalanceCtrl(robotModel,_data, _model);
